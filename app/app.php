<?php
    ...
    $app->get("/view_parcel", function() {
        ...
        if (empty($_GET['weight']) || empty($_GET['height']) || empty($_GET['length']) || empty($_GET['width'])) {
            return "<h3>Oops! You missed a field. Go back and enter in all four requirements...</h3>";
        } else {
